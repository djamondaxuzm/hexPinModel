...
power = 20e6 # W
time_steps = [0.1,0.2,0.4,0.8,1.6,2.5,5,10,20,40,80,100]
integrate = openmc.deplete.PredictorIntegrator(operator, time_steps, power, timestep_units='d') # also better options available
integrate.integrate()
...
plt.errorbar(time, keff_mean, yerr=keff_sigma, fmt='-', capsize=3)
plt.xlabel("Time [d]")
