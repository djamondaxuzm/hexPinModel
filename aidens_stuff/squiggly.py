...
def define_flux_spectrum_tally(target_cell: openmc.Cell):
    ...
    # Define 500 logarithmically spaced energy bins
    E_min = 1e-5
    E_max = 20e6
    num_bins = 500
...
def process_spectrum(sp_file: str, name: str):
    ...
    try:
        with openmc.StatePoint(sp_file) as sp:
            ...
            # Calculate Lethargy Width: Δu_g = ln(E_upper / E_lower)
            delta_u = np.log(E_upper / E_lower)
            
            # Calculate Flux per Unit Lethargy: Φ(u) = Φ / Δu
