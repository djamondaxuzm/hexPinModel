...
materials_file.cross_sections = '/storage/work/ajg7072/NUCE_403/endf/cross_sections.xml'
...
bottom = openmc.YPlane(surface_id=3, y0=-3, name='bottom')
top = openmc.YPlane(surface_id=4, y0=3, name='top')                    
